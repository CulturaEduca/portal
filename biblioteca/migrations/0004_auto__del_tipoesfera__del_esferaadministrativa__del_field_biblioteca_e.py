...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Biblioteca.esfera_administrativa'
        db.delete_column(u'biblioteca_biblioteca', 'esfera_administrativa_id')


        # Changing field 'Biblioteca.tipo_esfera'
        db.alter_column(u'biblioteca_biblioteca', 'tipo_esfera_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['referencia.TipoEsfera'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Biblioteca.esfera_administrativa'
        db.add_column(u'biblioteca_biblioteca', 'esfera_administrativa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.EsferaAdministrativa'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Biblioteca.tipo_esfera'
        db.alter_column(u'biblioteca_biblioteca', 'tipo_esfera_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.TipoEsfera'], null=True))
