...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Museu.tipo_esfera'
        db.add_column(u'museu_museu', 'tipo_esfera',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['referencia.TipoEsfera'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Museu.tipo_esfera'
        db.delete_column(u'museu_museu', 'tipo_esfera_id')
